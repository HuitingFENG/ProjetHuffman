// Projet Huffman version naive
// Veuillez creer un dossier "Projet Huffman" dans votre disque C et creer un dossier "Test Files" dans le "Projet Huffman"
// Veuillez bien mettre tous les treize fichiers .txt dans le dossier "Test Files"
